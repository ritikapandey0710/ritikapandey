...
- Name: user-management.spec.ts >> User Management (Admin Only) >> should display the user list with admin and agent users
- Location: e2e\tests\user-management.spec.ts:61:7
