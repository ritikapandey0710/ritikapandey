...
- generic [ref=f2e3]:
  - complementary [ref=f2e4]:
    ...
    - navigation [ref=f2e10]:
      - list [ref=f2e11]:
        - listitem [ref=f2e12]:
          - link "Dashboard" [ref=f2e13] [cursor=pointer]:
            - /url: /
        - listitem [ref=f2e18]:
          - link "Tickets" [ref=f2e19] [cursor=pointer]:
            - /url: /tickets
        - listitem [ref=f2e23]:
          - link "Users" [ref=f2e24] [cursor=pointer]:
            - /url: /user
    - button "Sign Out" [ref=f2e32]
  - generic [ref=f2e37]:
    - banner [ref=f2e38]:
      - heading "Help Desk" [level=1] [ref=f2e40]
      - generic [ref=f2e41]:
        - generic [ref=f2e42]:
          - generic [ref=f2e43]: A
          - generic [ref=f2e44]:
            - paragraph [ref=f2e45]: Admin User
            - paragraph [ref=f2e46]: admin@example.com
        - button "Sign Out" [ref=f2e47]
    - main [ref=f2e52]:
      - generic [ref=f2e54]:
        - generic [ref=f2e55]:
          - button "Back to Tickets" [ref=f2e56]
          - heading "Ticket Details" [level=1] [ref=f2e59]
        - generic [ref=f2e61]:
          - generic [ref=f2e62]:
            - heading "Service outage reported" [level=2] [ref=f2e63]
            - generic [ref=f2e64]:
              - generic [ref=f2e65]:
                - strong [ref=f2e66]: "Ticket #:"
                - text: TKT-00180
              - generic [ref=f2e67]:
                - strong [ref=f2e68]: "Status:"
                - generic [ref=f2e69]: Resolved
              - generic [ref=f2e70]:
                - strong [ref=f2e71]: "Priority:"
                - generic [ref=f2e72]: High
              - generic [ref=f2e73]:
                - strong [ref=f2e74]: "Category:"
                - generic [ref=f2e75]: General Question
          - generic [ref=f2e76]:
            - generic [ref=f2e77]:
              - generic [ref=f2e78]:
                - heading "Sender Information" [level=3] [ref=f2e79]
                - generic [ref=f2e80]:
                  - generic [ref=f2e81]:
                    - paragraph [ref=f2e82]: Name
                    - paragraph [ref=f2e83]: Gagan Thakur
                  - generic [ref=f2e84]:
                    - paragraph [ref=f2e85]: Email
                    - paragraph [ref=f2e86]: gagan.thakur@example.com
              - generic [ref=f2e87]:
                - heading "Assignee" [level=3] [ref=f2e88]
                - generic [ref=f2e89]:
                  - generic [ref=f2e90]: L
                  - generic [ref=f2e91]: agent 1
              - generic [ref=f2e92]:
                - heading "Status" [level=3] [ref=f2e93]
                - generic [ref=f2e94]: Resolved
              - generic [ref=f2e95]:
                - heading "Category" [level=3] [ref=f2e96]
                - generic [ref=f2e97]: General Question
              - generic [ref=f2e98]:
                - heading "Description" [level=3] [ref=f2e99]
                - paragraph [ref=f2e100]: No description provided
              - generic [ref=f2e101]:
                - heading "Timestamps" [level=3] [ref=f2e102]
                - generic [ref=f2e103]:
                  - generic [ref=f2e104]:
                    - paragraph [ref=f2e105]: Created At
                    - paragraph [ref=f2e106]: Aug 10, 2026, 03:56 AM
                  - generic [ref=f2e107]:
                    - paragraph [ref=f2e108]: Updated At
                    - paragraph [ref=f2e109]: Aug 17, 2026, 08:12 PM
            - generic [ref=f2e112]:
              - generic [ref=f2e113]:
                - heading "Assignee" [level=3] [ref=f2e114]
                - generic [ref=f2e115]:
                  - generic [ref=f2e116]: "Assign to:"
                  - combobox "Assign to:" [ref=f2e117]:
                    - option "Unassigned"
                    - option "agent3 (agent3@example.com)"
                    - option "agent2 (agent2@example.com)"
                    - option "agent 1 (agent1@example.com)" [selected]
                - button "Save Changes" [ref=f2e118]
              - generic [ref=f2e119]:
                - heading "Status" [level=3] [ref=f2e120]
                - generic [ref=f2e121]:
                  - generic [ref=f2e122]: "Status:"
                  - combobox "Status:" [ref=f2e123]:
                    - option "Open"
                    - option "In Progress"
                    - option "Resolved" [selected]
                    - option "Closed"
                - button "Save Changes" [ref=f2e124]
              - generic [ref=f2e125]:
                - heading "Category" [level=3] [ref=f2e126]
                - generic [ref=f2e127]:
                  - generic [ref=f2e128]: "Category:"
                  - combobox "Category:" [ref=f2e129]:
                    - option "— None —"
                    - option "General Question" [selected]
                    - option "Technical Question"
                    - option "Refund Request"
                - button "Save Changes" [ref=f2e130]
        - generic [ref=f2e131]:
          - generic [ref=f2e132]:
            - heading "AI Summary" [level=3] [ref=f2e133]
            - button "Summarize" [ref=f2e134]
          - paragraph [ref=f2e139]: Click ✨ Summarize to generate an AI summary of this ticket and conversation
        - generic [ref=f2e140]:
          - heading "Replies" [level=3] [ref=f2e141]
          - generic [ref=f2e143]:
            - generic [ref=f2e144]: A
            - generic [ref=f2e145]:
              - generic [ref=f2e146]:
                - generic [ref=f2e147]: Admin User
                - generic [ref=f2e148]: Agent
                - generic [ref=f2e149]: 8/17/2026, 8:12:24 PM
              - paragraph [ref=f2e150]: Hello Gagan, Thank you for reaching out. I understand that your issue has not been resolved yet. Please let us know if you are still experiencing this problem or if you can provide any additional details so we can assist you further. Best regards, Admin User
          - generic [ref=f2e151]:
            - heading "Write a Reply" [level=3] [ref=f2e152]
            - generic [ref=f2e153]:
              - generic [ref=f2e154]:
                - generic [ref=f2e155]: Write a reply
                - textbox "Write a reply" [ref=f2e156]:
                  - /placeholder: Type your reply here...
                  - text: Hello, I am checking this issue and will get back to you shortly.
                - paragraph [ref=f2e157]: "Failed to polish reply: Failed to polish reply: You exceeded your current quota, please check your plan and billing details. For more information on this error, head to: https://ai.google.dev/gemini-api/docs/rate-limits. To monitor your current usage, head to: https://ai.dev/rate-limit. * Quota exceeded for metric: generativelanguage.googleapis.com/generate_content_free_tier_requests, limit: 20, model: gemini-3.6-flash Please retry in 59.056912122s."
              - generic [ref=f2e158]:
                - button "Polish Reply" [ref=f2e160]
                - button "Send Reply" [ref=f2e161]
```
...
```ts
  ...
  84  |     
  85  |     // Verify Gemini actually returned modified text
> 86  |     expect(polishedText).not.toBe(originalReply);
      |                              ^ Error: expect(received).not.toBe(expected) // Object.is equality
